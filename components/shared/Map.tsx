            ...
            {loc.scanLat != null && loc.scanLong != null && (
                ...
                <Popup>
                     <div className="flex flex-col p-1" style={{ minWidth: 160 }}>
                        ...
                        <span style={{fontSize: "12px", color: "#555"}}>{loc.eventSource === "self_leader" ? "Leader Attendance Log" : loc.eventSource === "self_student" ? "Self-Logged Time Out" : "Attendance Scanner"}</span>
                        <span style={{fontSize: "12px", color: "#555"}}>Recorded at: {loc.recordedAt}</span>
                    </div>
                </Popup>
            </Marker>
