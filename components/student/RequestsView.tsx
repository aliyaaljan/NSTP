...
export default function RequestsView() {
 ...
 const { isLeader: isCurrentUserLeader, isLoading: contextLoading } = useStudent()
 ...
 useEffect(() => {
   ...
   setEditTimeCorrection(inferTimeCorrectionState(selectedRequest, sessionOptions))
   setEditNewFiles([])
         ...
         <KpiStatCardGrid columns={4}>
           ...
           <div className="request-top-bar">
               ...
               <button
                   ...
                   color: activeRequestFilters.type?.length ? C.maroon : C.green,
                   position: "relative",
                   }}
               >
           ...
           {isEditable ? (
             <div style={{ marginTop: 4, marginBottom: 16 }}>
                 ...
                 <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 10 }}>
                   {editFiles.map((att, i) => (
                     ...
                     >
                       ...
                       >
                         <i className="ti ti-paperclip" style={{ fontSize: 16, color: C.green, flexShrink: 0 }} />
               ...
               {editFiles.length + editNewFiles.length < MAX_NUM_ATTACHMENT && (
                 ...
                 >
                   <span style={{ fontSize: 13, fontWeight: 700, color: C.green }}>Drop your file here</span>
                   <span style={{ fontSize: 12, color: C.textMuted, marginTop: 4 }}>or click to browse</span>
                   <input
                     type="file"
                     hidden
                     multiple
